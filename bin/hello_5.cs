// Dafny program hello_5.dfy compiled into C#
...
// Dafny 3.2.0.30713
// Command Line Options: c:\Users\elija\Downloads\hello_5.dfy /verifyAllModules /compile:3 /spillTargetCode:1 /out:bin\hello_5
// hello_5.dfy

method Main()
{
  var ice := [1, 2, 2, 2, 3, 4, 4, 5];
  print ice[1 .. |ice| - 1];
}
")]
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      Dafny.ISequence<BigInteger> _10_ice;
      _10_ice = Dafny.Sequence<BigInteger>.FromElements(BigInteger.One, new BigInteger(2), new BigInteger(2), new BigInteger(2), new BigInteger(3), new BigInteger(4), new BigInteger(4), new BigInteger(5));
      Dafny.Helpers.Print((_10_ice).Subsequence(BigInteger.One, (new BigInteger((_10_ice).Count)) - (BigInteger.One)));
    }
  }
